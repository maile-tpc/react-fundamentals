...
- Synthetic Events!
- htmlFor
- bootstrapping technique between DOM elements and functions/vars
- controlled inputs are form elements that are directly controlled by logic, as opposed to the DOM reacting to user interaction and maintaining the state of the input
## Background
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=maile.lucks%40gmail.com).
